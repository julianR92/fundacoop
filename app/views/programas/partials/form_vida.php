...
<form method="post" action="<?=PROOT?>informeCaso/nuevo" id="frm" role="form" class="container" enctype="multipart/form-data">
   ...
   <h2 class="mt-3">Inscripción Programa Vida Club </h2>
   <hr>
   ...
   <div class="row mt-3">
   <div class="col-md-6">
      <a class="btn btn-link" target="_blank" href="#">Descargar Formulario en PDF Clic Aquí</a>
   </div>

   <?= FH::inputBlock('file', 'Subir Formulario en PDF', 'archivo', '', ['class' => 'form-control', 'accept'=> 'application/pdf'], ['class' => 'form-group col-md-6'], []) ?>
