...
$(function () {
   ...
   $(".nav a").each(function () {
      ...
      // console.log('comparar con '+path.substring(0, href.length));
      if (path.substring(0, href.length) === href||path.substring(0, href.length)+'/index' === href) {
        
         $(this).closest('li a').addClass('active');
         $(this).closest('ul .has-treeview').addClass('menu-open');
      }
   });
});
